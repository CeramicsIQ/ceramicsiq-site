...
export default async function HomePage() {
  ...
  return (
    <div className="bg-warm">
      ...
      <section className="max-w-6xl mx-auto px-8 py-7 grid grid-cols-[1fr_340px_260px] gap-7 border-b border-line">
        {/* Lead story */}
        <div>
          <ArticleCard article={lead} size="large" />
        </div>
      ...
      {/* ── Newsletter bar ── */}
      <section className="bg-cream border-b border-line">
        <div className="max-w-6xl mx-auto px-8 py-6 flex items-center justify-between gap-6 flex-wrap">
          <div>
            <h3 className="font-serif text-xl font-bold text-ash mb-0.5">
              Never miss a firing
            </h3>
      ...
      {/* ── Latest ── */}
      <section className="max-w-6xl mx-auto px-8 py-9 pb-16">
        <h2 className="text-[15px] font-bold uppercase tracking-wide text-ash mb-6">
          Latest
        </h2>
        <div className="grid grid-cols-[repeat(auto-fill,minmax(min(100%,300px),1fr))] gap-7">
