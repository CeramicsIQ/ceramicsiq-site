...
export default function AboutPage() {
  return (
    <div className="bg-warm">
      {/* Hero */}
      <section className="max-w-6xl mx-auto px-8 py-12 grid grid-cols-2 gap-12 items-center">
        <div>
          <h1 className="font-serif text-[42px] font-bold text-ash leading-tight mb-6">
            About CeramicsIQ
          </h1>
      ...
      <section className="py-10 px-8">
        <div className="max-w-[720px] mx-auto">
          ...
          <div className="bg-cream p-6 border border-line flex justify-between items-center flex-wrap gap-4">
            <div>
