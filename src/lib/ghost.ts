...
// ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Mock data (used until Ghost is connected) ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
...
export const mockArticles: Article[] = [
  {
    ...
    temp: "1,260ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°C", body: "Stoneware", atm: "Reduction",
    featured: true,
  },
  {
    ...
    image: IMG.teaBowl,
    temp: "1,220ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°C", body: "Kaolin", atm: "Oxidation",
    featured: true,
  },
  {
    ...
    image: IMG.studio,
    temp: "1,180ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°C", body: "Iron-rich", atm: "Neutral",
    featured: true,
  },
  {
    ...
    image: IMG.glaze,
    temp: "1,300ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°C", body: "Porcelain", atm: "Reduction",
  },
  {
    ...
    image: IMG.kiln,
    temp: "1,280ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°C", body: "Stoneware", atm: "Reduction",
  },
  {
    ...
    image: IMG.hero,
    temp: "1,200ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ°C", body: "Mixed", atm: "Oxidation",
  },
];

export const mockArtists: Artist[] = [
  { name: "Lin Kensington", technique: "Soda-fired ceramics & painting", location: "Oklahoma City, OK", image: "https://res.cloudinary.com/dw7tdz8ee/image/upload/v1775342911/LinKensingtonHeadshotArtist_psxha6.png", url: "https://LinKensingtonArt.com" },
  { name: "Taylor Sijan", technique: "Decorated functional pottery", location: "Catawba Island, OH", image: "https://res.cloudinary.com/dw7tdz8ee/image/upload/v1775415973/TaylorSijan_s2hvp6.png", url: "https://www.taylorsijan.com" },
  { name: "Akira Satake", technique: "Wood-fired ceramics", location: "Swannanoa, NC", image: "https://res.cloudinary.com/dw7tdz8ee/image/upload/v1775415754/AkiraSatake_qg8r7g.png", url: "https://akirasatake.com" },
  { name: "Andres Montenegro", technique: "Cone 6 glazed ceramics", location: "Daytona Beach, FL", image: "https://res.cloudinary.com/dw7tdz8ee/image/upload/v1775415770/AndresMontenegro_rdba16.png", url: "https://www.montenegroceramics.com" },
  { name: "Marissa Childers", technique: "Functional ceramics & workshops", location: "Clay & Thistle Studio", image: "https://res.cloudinary.com/dw7tdz8ee/image/upload/v1775415886/MarissaChilders_ojzj10.png", url: "https://www.marissachilders.com" },
];

// ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Helpers ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
 ...
 * - "word ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ word" or "word ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ word" ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ "word, word"
 * - "60ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ80%" ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ "60 to 80%"
 * - "&mdash;" / "&ndash;" / "&#8212;" / "&#8211;" ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ same rules
 */
...
// ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Ghost API functions ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
...
// ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ Public API ÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ
